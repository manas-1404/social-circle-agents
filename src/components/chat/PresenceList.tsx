...
export function PresenceList({ roomId, shapes }: PresenceListProps) {
  ...
  return (
    <div className="flex flex-col gap-2 p-4">
      ...
      {shapes.length === 0 && (
        <p className="text-xs text-zinc-400 italic">No shapes yet</p>
      )}
      ...
      <button
        onClick={openPicker}
        disabled={adding}
        className="mt-2 text-xs text-blue-600 dark:text-blue-400 hover:underline text-left disabled:opacity-50"
      >
        + Add shape
      </button>
